...
{{-- @props(['post'])
<article class="border-b border-gray-100 pb-10 last:border-b-0">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-5 article-body bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-4 rounded-lg shadow-lg">
        <div class="lg:col-span-4">
            <a href="{{ route('posts.show', $post->slug) }}" class="block hover:opacity-95 transition-opacity duration-200 ease-in-out">
                <img class="rounded-lg mx-auto shadow-sm hover:shadow-md transition-shadow duration-300 ease-in-out" src="{{ $post->getThumbnailUrl() }}" alt="thumbnail">
            </a>
...
{{-- 
 @props(['post'])
<article class="border-b border-gray-100 pb-10 last:border-b-0">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-5 article-body bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 p-4 rounded-lg shadow-lg">
        <div class="lg:col-span-4">
            <a href="{{ route('posts.show', $post->slug) }}" class="block hover:opacity-95 transition-opacity duration-200 ease-in-out">
                <img class="rounded-lg mx-auto shadow-sm hover:shadow-md transition-shadow duration-300 ease-in-out" src="{{ $post->getThumbnailUrl() }}" alt="thumbnail">
            </a>
